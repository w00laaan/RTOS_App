...
#define OS_MAX_QS                 4    /* Max. number of queue control blocks in your application ...  */
                                       /* ... MUST be > 0                                              */
#define OS_MAX_TASKS             24    /* Max. number of tasks in your application ...                 */
                                       /* ... MUST be >= 2                                             */
#define OS_LOWEST_PRIO           23    /* Defines the lowest priority that can be assigned ...         */
...
#define OS_TICKS_PER_SEC        300	/* Set the number of ticks in one second                        */
